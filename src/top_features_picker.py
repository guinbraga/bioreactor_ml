...
class TopFeaturesPicker:
    ...
    def pick_top_features(
        ...
        if self.cluster_features:
            ...
            missing_features = feature_importances.index.difference(
                clusters_series.index
            )
            ...
            sorted_cluster_importances = cluster_importances.sort_values(
                ascending=False
            )  # type: ignore
            ...
            selected_features = sorted_importances.iloc[: cutoff_index + 1]
